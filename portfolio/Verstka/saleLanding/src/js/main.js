class Timer {
  ...
  setTime({ days, hours, minutes, seconds } = { days: 0, hours: 3, minutes: 27, seconds: 48 }) {
    this.#days = days;
    this.#hours = hours;
  ...
  setClassNames({ days, hours, minutes, seconds }) {
  ...
  setOptions({ withZeros, timerStep } = { withZeros: true, timerStep: 1000 }) {
...
new Timer()
  .setTime()
  .setClassNames({ days: '.days', hours: '.hours', minutes: '.minutes', seconds: '.seconds' })
  .setOptions()
  .init()